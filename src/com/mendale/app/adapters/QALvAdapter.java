 ...
 * 
 */
public class QALvAdapter extends BaseAdapter {

	private Context context;
	private List<RecordPojo> recordList;

	public QALvAdapter(Context context, List<RecordPojo> recordList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context, R.layout.listview_item_qa, null);

 ...
 *
 */
public class UpLoadAddStepLVAdapter extends BaseAdapter {

	private LayoutInflater mInflater;
	private List<Step> text;
	ViewHolder holder;
	private Context context;

	public UpLoadAddStepLVAdapter(Context context, List<Step> text) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ImageOpera.getInstance(context).loadImage(text.get(position).getUrl(), holder.pic);
		holder.desc.setText(text.get(position).getContent());

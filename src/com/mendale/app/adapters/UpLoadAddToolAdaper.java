 ...
 *
 */
public class UpLoadAddToolAdaper extends BaseAdapter {

	private LayoutInflater mInflater;
	private List<Tool> text;
	ViewHolder holder;

	public UpLoadAddToolAdaper(Context context, List<Tool> text) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.amount.setText(text.get(position).getNum());

...
public class DataURL {
	...
	// 首页
	public static String HOME_URL = "http://www.shougongke.com/index.php?m=Mobq_data&id=5";
	// 教程
	public static String COURSE_URL = "http://www.shougongke.com/index.php?m=Mobq_data&a=cate";
	// 记录

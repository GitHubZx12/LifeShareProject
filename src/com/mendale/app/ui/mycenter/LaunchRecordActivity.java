 ...
 *
 */
public class LaunchRecordActivity extends Activity implements IXListViewListener, OnClickListener {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				if (msg.obj != null) {
					...
					mAdapter = new RecordLVAdapter(LaunchRecordActivity.this, recordList, options);
	...
	private void initAnim() {
		Animation animation = AnimationUtils.loadAnimation(LaunchRecordActivity.this, R.anim.loading);
	...
	private void initData() {
		new Thread() {
			public void run() {
				...
				new RecordTask(LaunchRecordActivity.this, mhandler).send(1, "utf-8", DataURL.RECORD_URL);
			};
		}.start();
	}
	...
	private void initView() {
		mListView = (XListView) findViewById(R.id.listview_record);
		...
		ll_loading = (LinearLayout) findViewById(R.id.ll_record_loading);
		//
		recordAction = (TextView) findViewById(R.id.iv_record_action);
		//

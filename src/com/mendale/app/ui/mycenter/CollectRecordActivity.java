 ...
 *
 */
public class CollectRecordActivity extends Activity implements IXListViewListener, OnClickListener {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				if (msg.obj != null) {
					...
					mAdapter = new RecordLVAdapter(CollectRecordActivity.this, recordList, options);
	...
	private void initAnim() {
		Animation animation = AnimationUtils.loadAnimation(CollectRecordActivity.this, R.anim.loading);

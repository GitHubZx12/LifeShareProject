...
//	private ImageButton iv_list;
     ...
     * 应用推荐
     */
    private TextView tv_menurecommond;
    /**
     * 头像
     */
    ...
    protected void onResume() {
        int id = getIntent().getIntExtra("recordflag", 0);
...
//		menu.setBehindOffset(50);
    ...
    private void init() {
        ...
        tv_menurecommond= (TextView) findViewById(R.id.tv_menurecommond);
        //
    }
...
//		iv_list.setOnClickListener(this);
        ...
        tv_menurecommond.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_menu_classify://分类
                ...
                break;
            case R.id.tv_menurecommond://应用推荐

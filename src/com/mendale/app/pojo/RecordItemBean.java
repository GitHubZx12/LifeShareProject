...
public class RecordItemBean extends BmobObject{
	...
	public String toString() {
		return "RecordItemBean [opus_id=" + opus_id + ", subject=" + subject + ", uid=" + uid + ", host_pic=" + host_pic
				+ ", content=" + content + ", user_name=" + user_name + ", face_pic=" + face_pic + ", view=" + view
				+ ", collect=" + collect + ", comment=" + comment + ", laud=" + laud + "]";
	}
